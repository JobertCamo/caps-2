...
<body>
    <section class="max-w-2xl px-6 py-8 mx-auto bg-white dark:bg-gray-900">
        ...
        <main class="mt-8">
            <h2 class="text-gray-700 dark:text-gray-200 ">Hi <strong>{{ $first_name . $last_name }},</strong></h2>
    
            <p class="mt-2 leading-loose text-gray-600 dark:text-gray-300">
                We regret to inform you that you were not selected for the next stage of the interview process. We appreciate the time and effort you invested and encourage you to apply for future opportunities with us.
            </p>
